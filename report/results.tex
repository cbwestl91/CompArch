...
An attempt to do special treatment of the reoccurring scenario linear access was implemented, but the results were neglishable. This suggests that the algorithm works well in these situations, and the attempt was scrapped early on, as it added complexity without any real pay-out.
